...
class CustomTaxonomy {
     ...
     *
     * @param string $type Internal name of Custom Taxonomy.
     * @param string $singular_label Custom Taxonomy Name in singular form.
     * @param string $plural_label Custom Taxonomy Name in plural form.
     * @param string $post_types Links the Custom Taxonomy to a Post, Page, CPT, ...
     * @param mixed $settings Custom user settings to override default Custom Taxonomy values.
     */
